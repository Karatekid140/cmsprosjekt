...
{var field=$(this);field.removeClass('fl-form-error');field.siblings('.fl-form-error-message').hide();}};$(function(){FLBuilderLayout.init();});})(jQuery);jQuery(function($){$(function(){$('.fl-node-5bbdc44e369ef .fl-photo-img').on('mouseenter',function(e){$(this).data('title',$(this).attr('title')).removeAttr('title');}).on('mouseleave',function(e){$(this).attr('title',$(this).data('title')).data('title',null);});});});(function($){BBTimelineAnimation=function(settings)
{this.settings=settings;this.timeline=settings.timeline;this.mobile_screen=settings.mobile_screen;this.animation=settings.animation;this.animation_delay=settings.animation_delay;this.viewport_position=settings.viewport_position;if(this.animation!='no'){this.nodeClass='.fl-node-'+settings.id;this._initAnimations();};};BBTimelineAnimation.prototype={settings:{},nodeClass:'',timeline:'',mobile_screen:'',animation:'',animation_delay:0,viewport_position:90,_initAnimations:function()
{if($(window).width()<768){if(this.mobile_screen=='on'){if(typeof jQuery.fn.waypoint!=='undefined'){$(this.nodeClass).find('.bb-tmtimeline .tm-timeline-li-'+this.timeline+' .bb-tmlabel').waypoint({offset:this.viewport_position+'%',handler:$.proxy(this._executeAnimation,this)});}}else{var module=$(this.nodeClass).find('.bb-tmtimeline .tm-timeline-li-'+this.timeline+' .bb-tmlabel');module.removeClass('bb-hide-it');}}else{if(typeof jQuery.fn.waypoint!=='undefined'){$(this.nodeClass).find('.bb-tmtimeline .tm-timeline-li-'+this.timeline+' .bb-tmlabel').waypoint({offset:this.viewport_position+'%',handler:$.proxy(this._executeAnimation,this)});}}},_executeAnimation:function(e)
{var module=$(this.nodeClass).find('.bb-tmtimeline .tm-timeline-li-'+this.timeline+' .bb-tmlabel'),animation_class=this.animation,delay=parseInt(this.animation_delay);if(delay>0){setTimeout(function(){module.removeClass('bb-hide-it');module.addClass(animation_class);},delay*1000);}
else{module.removeClass('bb-hide-it');module.addClass(animation_class);}},};})(jQuery);(function($){$(document).ready(function(){});})(jQuery);;if(typeof FLBuilder!=='undefined'&&typeof FLBuilder._renderLayoutComplete!=='undefined')FLBuilder._renderLayoutComplete();