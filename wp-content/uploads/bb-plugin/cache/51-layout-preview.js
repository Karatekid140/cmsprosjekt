...
{var field=$(this);field.removeClass('fl-form-error');field.siblings('.fl-form-error-message').hide();}};$(function(){FLBuilderLayout.init();});})(jQuery);(function($){BBTimelineAnimation=function(settings)
...
else{module.removeClass('bb-hide-it');module.addClass(animation_class);}},};})(jQuery);(function($){$(document).ready(function(){});})(jQuery);jQuery(function($){$(function(){$('.fl-node-5bbdc0370afb1 .fl-photo-img').on('mouseenter',function(e){$(this).data('title',$(this).attr('title')).removeAttr('title');}).on('mouseleave',function(e){$(this).attr('title',$(this).data('title')).data('title',null);});});});;if(typeof FLBuilder!=='undefined'&&typeof FLBuilder._renderLayoutComplete!=='undefined')FLBuilder._renderLayoutComplete();